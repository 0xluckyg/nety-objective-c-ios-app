//
//  N_CoreDataTableViewController.m
//  Nety
//
...
@interface N_CoreDataTableViewController ()<UITableViewDelegate,UITableViewDataSource>


@end

@implementation N_CoreDataTableViewController
      ...
      newIndexPath:(NSIndexPath *)newIndexPath
{
    ...
    switch(type) {
        case NSFetchedResultsChangeInsert:
            [_table insertRowsAtIndexPaths:@[newIndexPath] withRowAnimation:UITableViewRowAnimationFade];
            break;
        ...
        case NSFetchedResultsChangeUpdate:
            [self configureCell:[_table cellForRowAtIndexPath:indexPath] withObject:anObject];
            break;
